...
root_dir = '/root/MixVPR/datasets/Pittsburgh/'
...
def get_whole_val_set():
    ...
    return WholeDatasetFromStruct(structFile, input_transform=input_transform(image_size))
...
def get_whole_training_set(onlyDB=False):
    ...
    return WholeDatasetFromStruct(structFile,
                                  input_transform=input_transform(image_size),
                                  onlyDB=onlyDB)
